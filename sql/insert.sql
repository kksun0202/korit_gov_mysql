...
insert into `db_study`.`student_tb`(`student_name`, `student_age`) values('김선영',32);
insert into student_tb values('김선일',33);
#NULL 값을 넣을 수 있는 컬럼만 생략 가능
insert into student_tb(student_age) values(34);
insert into student_tb(student_age, student_name) values(35, '김선삼');
...
values('김선사', 35),('김선오', 36);

/*
	수업(class_register_tb)을 정의한다. 컬럼은 아래와 같다.
    class_name
    price
    student_name
    student_age
...
insert into class_register_tb(class_name, price, student_name, student_age)
values
    ('Java 기초',			150000, '김민수', 22),
    ('Python 웹개발',		200000, '이서연', 24),
    ('React 입문',		180000, '박지훈', 21),
